      ...
      >
        <div class="title_part">
          <div>
            ...
            <h1 class="now_title">{{$t("new.records.withdrawal")}}</h1>
          </div>
        </div>
        <div class="table_all">
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: this.$t("new.finance.operate.withdrawalFees"),
          key: "witFee",
        },
        {
          title: this.$t("carouselItem.text165"),
          key: "witArrivedAmount",
        },
        {
          title: this.$t("carouselItem.text166"),
          key: "witStatus",
        },
      ],
      data: [],
