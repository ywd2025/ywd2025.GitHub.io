      ...
      >
        <div class="title_part">
          <div>
            ...
            <h1 class="now_title">{{ $t("dolphin.text58") }}</h1>
          </div>
        </div>
        <div class="table_all">
          ...
          <div class="table_part">
            ...
            >
              <template slot-scope="{ row }" slot="witAddress">
                <div>
                  {{ $t("carouselItem.text148") }}
                </div>
              </template>
              <template slot-scope="{ row }" slot="witStatus">
