      ...
      >
        <div class="title_part">
          <div>
            ...
            <h1 class="now_title">{{ $t("carouselItem.text119") }}</h1>
          </div>
        </div>
        <div class="table_all">
...
export default {
            ...
            return h(
              "Button",
              {
                props: {
                  size: "small",
                  type: "success",
                  disabled: params.row.isRedemption != 0,
                },
                on: {
                  click: () => {
  ...
  methods: {
    ...
    getListData() {
      ...
      this.$http
        .post(this.host + this.api.financialRecords.purchaseApi, params)
        .then((res) => {
      ...
      this.$Modal.confirm({
        ...
        onOk: () => {
          this.$http
            .get(
              this.host +
                this.api.financialRecords.redemptionApi +
                "/" +
                row.id,
              {}
            )
