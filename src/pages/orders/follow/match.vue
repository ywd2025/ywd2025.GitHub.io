      ...
      >
        <div class="title_part">
          <div>
            ...
            <h1 class="now_title">{{ $t("carouselItem.text266") }}</h1>
          </div>
        </div>
        <div class="table_all">
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          align: "center",
          render: (h, params) => {
            return h("span", {}, params.row.currentPrice.toFixed(4));
          },
        },
        {
          title: this.$t("carouselItem.text234"),
          key: "tradedPrice",
          align: "center",
          render: (h, params) => {
            return h("span", {}, this.fixed_filter(params.row.tradedPrice));
          },
        },
        {
          ...
          render: (h, params) => {
            if (params.row.profitAndLoss < 0) {
              return h(
                "span",
                { style: { color: "#FF0000" } },
                this.fixed_filter(params.row.profitAndLoss)
              );
            } else {
              return h(
                "span",
