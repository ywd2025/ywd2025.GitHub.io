...
WebsockFeed.prototype.subscribeBars = function(symbolInfo, resolution, onRealtimeCallback, listenerGUID, onResetCacheNeededCallback) {
    var that = this;
    this.stompClient.subscribe('/topic/second/trade/'+symbolInfo.name, function(msg) {
    ...
    this.stompClient.subscribe("/topic/second/thumb", function(msg) {
          var resp = JSON.parse(msg.body);
    ...
    this.stompClient.subscribe('/topic/second/kline/'+symbolInfo.name, function(msg) {
