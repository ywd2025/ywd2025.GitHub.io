(function() {
  ...
  function k() {
    var a,
      ...
      g = arguments.length,
      l = !1;
    "boolean" === typeof f && ((l = f), (f = arguments[h] || {}), h++);
      ...
      if (null != (a = arguments[h]))
        for (b in a)
          (c = f[b]),
            (e = a[b]),
            f !== e &&
              (l && e && (m(e) || (d = Array.isArray(e)))
                ? (d
                    ? ((d = !1), (c = c && Array.isArray(c) ? c : []))
                    : (c = c && m(c) ? c : {}),
                  (f[b] = k(l, c, e)))
                : void 0 !== e && (f[b] = e));
    return f;
  ...
  function g(a) {
    d.widget.prototype[a] = function(b) {
      console.warn(
        "Method `" +
          a +
          "` is obsolete. Please use `chart." +
          a +
          "()` subscription method instead."
      );
    };
  }
  if (!window.TradingView) {
    var n = {
      ...
      d = {
        ...
        HOLLOW_CANDLES: 9,
        version: function() {
          return "1.11 (internal id fe319232 @ 2017-11-14 03:44:26.632703)";
        },
        gEl: function(a) {
        ...
        css: function(a) {
          ...
          c.styleSheet
            ...
            : ((a = document.createTextNode(a)), c.appendChild(a));
          b.appendChild(c);
        },
        ...
        widget: function(a) {
          ...
          this.options = k(!0, b, {
            ...
            settingsAdapter: a.settings_adapter,
          });
            ...
            n[a]
              ? ((a = n[a]),
                (this.options.disabledFeatures =
                  0 < this.options.disabledFeatures.length
                    ? this.options.disabledFeatures.concat(a.disabledFeatures)
                    : a.disabledFeatures),
                (this.options.enabledFeatures =
                  0 < this.options.enabledFeatures.length
                    ? this.options.enabledFeatures.concat(a.enabledFeatures)
                    : a.enabledFeatures))
              : console.warn("Unknown preset: `" + a + "`"));
    ...
    d.widget.prototype = {
      ...
      _autoResizeChart: function() {
        this.options.fullscreen &&
          (d.gEl(this.id).style.height = window.innerHeight + "px");
      },
      create: function() {
        var a = this.render(),
          b = this,
        ...
        if (this.options.autosize || this.options.fullscreen)
          (e = d.gEl(this.id)),
            (e.style.width = "100%"),
            this.options.fullscreen || (e.style.height = "100%");
        ...
        var g = null,
          g = function() {
            ...
            c.contentWindow.widgetReady(function() {
              var a;
              b._ready = !0;
              for (a = b._ready_handlers.length; a--; )
                b._ready_handlers[a].call(b);
      ...
      render: function() {
        ...
        var a =
          (this.options.path || "") +
          "static/tv-chart.fe3192321931572c06b8.html#localserver=1&symbol=" +
          encodeURIComponent(this.options.symbol) +
          "&interval=" +
          encodeURIComponent(this.options.interval) +
          (this.options.timeframe
            ? "&timeframe=" + encodeURIComponent(this.options.timeframe)
            : "") +
          (this.options.toolbar_bg
            ? "&toolbarbg=" + this.options.toolbar_bg.replace("#", "")
            : "") +
          (this.options.studiesAccess
            ? "&studiesAccess=" +
              encodeURIComponent(JSON.stringify(this.options.studiesAccess))
            : "") +
          "&widgetbar=" +
          encodeURIComponent(JSON.stringify(this.options.widgetbar)) +
          (this.options.drawingsAccess
            ? "&drawingsAccess=" +
              encodeURIComponent(JSON.stringify(this.options.drawingsAccess))
            : "") +
          "&timeFrames=" +
          encodeURIComponent(JSON.stringify(this.options.time_frames)) +
          "&locale=" +
          encodeURIComponent(this.options.locale) +
          "&uid=" +
          encodeURIComponent(this.options.uid) +
          "&clientId=" +
          encodeURIComponent(this.options.client_id) +
          "&userId=" +
          encodeURIComponent(this.options.user_id) +
          (this.options.charts_storage_url
            ? "&chartsStorageUrl=" +
              encodeURIComponent(this.options.charts_storage_url)
            : "") +
          ...
          (this.options.indicators_file_name
            ? "&indicatorsFile=" +
              encodeURIComponent(this.options.indicators_file_name)
            : "") +
          ...
          (this.options.auto_save_delay
            ? "&autoSaveDelay=" +
              encodeURIComponent(this.options.auto_save_delay)
            : "") +
          "&debug=" +
          this.options.debug +
          (this.options.snapshotUrl
            ? "&snapshotUrl=" + encodeURIComponent(this.options.snapshotUrl)
            : "") +
          (this.options.timezone
            ? "&timezone=" + encodeURIComponent(this.options.timezone)
            : "") +
          (this.options.studyCountLimit
            ? "&studyCountLimit=" +
              encodeURIComponent(this.options.studyCountLimit)
            : "") +
          (this.options.symbolSearchRequestDelay
            ? "&ssreqdelay=" +
              encodeURIComponent(this.options.symbolSearchRequestDelay)
            : "");
        return (
          '<iframe id="' +
          this.id +
          ...
          (this.options.autosize || this.options.fullscreen
            ...
            : ' width="' +
              ...
              this.options.height +
              '"') +
          ' frameborder="0" allowTransparency="true" scrolling="no" allowfullscreen style="display:block;background: rgb(25, 35, 48);"></iframe>'
        );
      },
      ...
      unsubscribe: function(a, b) {
        this._innerWindow().tradingViewApi.unsubscribe(a, b);
      },
      ...
      applyOverrides: function(a) {
        this.options = k(!0, this.options, { overrides: a });
    ...
    [
      ...
      d.widget.prototype[a[0]] = function(b) {
        var c = a[1] || a[0];
        console.warn(
          "Method `" +
            a[0] +
            '` is obsolete. Please use `widget.subscribe("' +
            c +
            '", callback)` instead.'
        );
        this.subscribe(c, b);
    ...
    window.TradingView && jQuery
      ? jQuery.extend(window.TradingView, d)
