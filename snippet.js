    ...
    (() => {
      ...
      class i {
        ...
        load(e, t) {
          return this.productIframe
            .ready()
            .then((r) => {
              this.productIframe.injectMetadata(r, t),
                this.productIframe.injectAssets(r, e);
            })
            .catch(() => Promise.reject(this.loadProductError()));
        }
        loadProductError() {
          const { name: t, id: r, features: n } = this.product;
          return new e("failed to load product", {
            product: t,
            id: r,
            features: n,
          });
      ...
      class u {
        ...
        resolveComposeUrl(e = !1) {
          ...
          return (
            this.version &&
              ((t += `?${this.getSerializedVersionQueryParam()}`),
              this.displayWarning()),
            decodeURI(t)
          );
        }
        displayWarning() {
        //   console.warn(
        //     `You are loading ${this.version.name} version ${this.version.string}`
        //   );
        }
      ...
      class p {
        ...
        getProducts(e, n = !1) {
          return new Promise((s, o) => {
            ...
            if (n)
              (i.zEACLoaded = !0), i.$zopim ? s(r.products) : s(t.products);
            else {
              const t = (t) => {
                  200 === t.status
                    ? t
        ...
        loadProducts(e, t = !1) {
          return e.map((e) => {
            ...
            return e
              .load(r, this.snippet.getZEQueue())
        ...
        getProductLoaders(e) {
          ...
          return e.map((e) =>
            "zopim_chat" === e.name ? new c(e.id, t) : new i(e, t)
          );
        }
        error(t) {
      ...
      class l {
        ...
        getKey() {
          return new Promise((t, r) =>
            r(new e("Key is missing from snippet", {}, !0))
          );
        }
        getZEQueue() {
          return null;
      ...
      class g extends l {
        getKey() {
          return new Promise((e, t) =>
            e(
              `zopim_chat/${(0, a.getQueryParamsString)(
                g.getScriptSrc(this.win)
              )}`
            )
          );
        }
        static getScriptSrc(e) {
          ...
          for (let e = 0, s = t.length; e < s; e++)
            if (((n = t[e].src || ""), r.test(n))) return n;
        }
        static isSnippetPresent(e) {
        ...
        return t && t instanceof e
          ? y().then((e) => {
              e.withScope((r) => {
                ...
                // window.console &&
                //   t.isUserError &&
                //   window.console.error(t.message);
            }
            )
          : y().then((e) => {
      ...
      !(function () {
        try {
          ...
          e.getKey()
            ...
            .then((e) => {
              if (e && e.length)
                return Promise.all(t.loadProducts(t.getProductLoaders(e), r));
            })
            .catch((e) => b(e));
        } catch (e) {
          b(e);
